...
\IEEEauthorblockA{\IEEEauthorrefmark{1}Servicio Nacional de Aprendizaje (SENA)\\
Regional Huila, Centro de la Industria, la Empresa y los Servicios (CIES)\\
Ficha 2899747\\
\texttt{jpsaavedra32@soy.sena.edu.co}}
\and
\IEEEauthorblockN{Jesus Ariel González Bonilla\IEEEauthorrefmark{2}}
\IEEEauthorblockA{\IEEEauthorrefmark{2}Instructor\\
